...
export default function BookingsPage() {
    ...
    const [form, setForm] =
        useState<BookingRequest>(emptyForm);
    ...
    async function loadData() {
        try {
            ...
            const [bookingData, guestData, roomData] =
                await Promise.all([
                    getBookings(),
                    getGuests(),
                    getRooms(),
    ...
    async function handleSubmit(
        ...
        try {
            if (
                ...
                throw new Error(
                    "Please select a guest and a room."
                );
            }
    ...
    const status = getBookingStatusName(
        ...
        <div className="mx-auto max-w-7xl px-6 py-10">
            ...
            {guests.length === 0 && (
                <div className="mb-6 rounded-lg bg-yellow-100 p-4 text-yellow-800">
                    You need at least one guest before creating
                    a booking.
                </div>
            )}
            ...
            {rooms.length === 0 && (
                <div className="mb-6 rounded-lg bg-yellow-100 p-4 text-yellow-800">
                    You need at least one room before creating
                    a booking.
                </div>
            )}
                        ...
                        <tbody>
                            {filteredBookings.map((booking) => (
                                ...
                                >
                                    ...
                                    <td className="p-4">
                                        €
                                        {booking.totalBookingPrice.toFixed(
                                            2
                                        )}
                                    </td>
